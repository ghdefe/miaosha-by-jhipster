...
export class GoodComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.goodService
      ...
      .subscribe(
        (res: HttpResponse<IGood[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInGoods(): void {
    this.eventSubscriber = this.eventManager.subscribe('goodListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IGood[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
