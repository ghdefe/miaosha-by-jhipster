...
@RestController
@RequestMapping("/api/miaosha-by-jhipster-kafka")
public class MiaoshaByJhipsterKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MiaoshaByJhipsterKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MiaoshaByJhipsterKafkaResource(KafkaProperties kafkaProperties) {
